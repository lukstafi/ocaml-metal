...
let%expect_test "Metal shader logging" =
  ...
  [%expect {|
    ...
    Captured shader logs:
    [Debug] Metal/MetalPlugin: Thread 0 started processing
    [Debug] Metal/MetalPlugin: Thread 0 calculation complete: 2.000000
    [Debug] Metal/MetalPlugin: Thread 1 started processing
    [Debug] Metal/MetalPlugin: Thread 1 calculation complete: 4.000000
    [Debug] Metal/MetalPlugin: Thread 2 started processing
    [Debug] Metal/MetalPlugin: Thread 2 calculation complete: 6.000000
    [Debug] Metal/MetalPlugin: Thread 3 started processing
    [Debug] Metal/MetalPlugin: Thread 3 calculation complete: 8.000000
  |}] 