...
let () =
  ...
  Printf.printf "Command buffer 1 created\n%!";
  ...
  Printf.printf "Compute encoder 1 created and set\n%!";
  ...
  Printf.printf "Threads dispatched on first encoder\n%!";
  ...
  Printf.printf "Second command buffer created\n%!";
  ...
  Printf.printf "Wait for event encoded\n%!";
  ...
  Printf.printf "Blit encoder encoding completed\n%!";
  ...
  Printf.printf "Compute encoder 2 created and set\n%!";
  ...
  Printf.printf "Threads dispatched on second encoder\n%!";
  
  Metal.ComputeCommandEncoder.end_encoding compute_encoder2;
  Printf.printf "Second compute encoder encoding completed\n%!";
